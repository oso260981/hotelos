    ...
    <div class="modal-container-edit" onclick="event.stopPropagation()">
        ...
        <footer class="p-8 border-t bg-slate-50 flex justify-end gap-3">
            ...
            <button onclick="saveProfile()"
                class="px-10 py-4 bg-indigo-600 text-white rounded-2xl font-black text-[10px] uppercase shadow-xl hover:bg-indigo-700 transition-all">Sincronizar
                SQL</button>
        </footer>
    </div>
</div>
        ...
        <div class="modal-container-edit" style="max-width: 800px; height: 75vh;" onclick="event.stopPropagation()">
            <header class="px-8 py-6 border-b flex justify-between items-center bg-slate-50">
                <div>
                    ...
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Gestión Técnica de registro_acompanantes</p>
                </div>
                <button onclick="toggleCompanionsList(false)" class="w-10 h-10 rounded-full hover:bg-slate-200 text-slate-400 flex items-center justify-center">
            ...
            <footer class="p-8 border-t bg-slate-50 flex justify-between items-center">
                ...
                <button onclick="openCompanionForm(-1)" class="bg-indigo-600 text-white px-6 py-3 rounded-xl font-black text-[11px] uppercase shadow-lg">
    ...
    <div id="modal-companion-form" class="modal-overlay-sub" style="z-index: 1100;" onclick="toggleCompanionForm(false)">
        <div class="modal-container-edit" onclick="event.stopPropagation()">
            <header class="px-8 py-4 border-b bg-slate-50 flex justify-between items-center">
                ...
                <button onclick="toggleCompanionForm(false)" class="w-8 h-8 rounded-full hover:bg-red-50 hover:text-red-500 text-slate-400 flex items-center justify-center"><i class="fas fa-times"></i></button>
            </header>
            <div class="flex-1 overflow-y-auto custom-scroll p-8 bg-white">
                <div class="grid grid-cols-12 gap-8">
                    ...
                    <div class="col-span-4 space-y-6">
                        <div class="bg-slate-900 p-4 rounded-[24px] text-center shadow-xl border-t-4 border-indigo-600">
                            ...
                            <div class="grid grid-cols-1 gap-2">
                                <button id="btn-cam-comp" onclick="startCamera('comp')" class="w-full py-2.5 bg-indigo-600 text-white rounded-xl font-black text-[9px] uppercase tracking-widest">Prender Cámara</button>
                                <button id="btn-snap-comp" onclick="takePhoto('comp')" class="hidden w-full py-2.5 bg-emerald-600 text-white rounded-xl font-black text-[9px] uppercase tracking-widest">Tomar Foto</button>
                            </div>
                        </div>
                    ...
                    <div class="col-span-8 grid grid-cols-2 gap-x-6 gap-y-5">
                        <div class="col-span-2 border-b pb-2"><h4 class="font-black text-xs text-indigo-600 uppercase">Datos de Identidad & SQL</h4></div>
                        
                        <!-- Nombre y Apellido (nombre / apellido) -->
                        <div><label class="pms-label">Nombre(s)</label><input type="text" id="comp-name" class="pms-input"></div>
                        <div><label class="pms-label">Apellido(s)</label><input type="text" id="comp-lastName" class="pms-input"></div>
                        ...
                        <div><label class="pms-label">Número de ID</label><input type="text" id="comp-id" class="pms-input"></div>

                        <!-- Vínculo y Menor (parentesco / es_menor) -->
                        <div><label class="pms-label">Parentesco</label><input type="text" id="comp-rel" class="pms-input" placeholder="Ej: Esposa, Hijo, Socio"></div>
                        <div class="flex items-center justify-between bg-slate-50 p-4 rounded-2xl">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <div class="w-11 h-6 bg-slate-200 rounded-full peer peer-checked:bg-amber-500 peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                            </label>
                        </div>

                        <div class="col-span-2 border-b pb-2 pt-2"><h4 class="font-black text-xs text-emerald-600 uppercase">Tiempos & Estado Estancia</h4></div>

                        <!-- Horarios (hora_entrada / hora_salida) -->
                        <div><label class="pms-label">Hora Entrada</label><input type="datetime-local" id="comp-entrada" class="pms-input"></div>
                        <div><label class="pms-label">Hora Salida</label><input type="datetime-local" id="comp-salida" class="pms-input"></div>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea id="comp-obs" class="pms-input h-20 resize-none text-[11px]" placeholder="Notas adicionales del acompañante..."></textarea>
                        </div>
                    </div>
                </div>
            </div>
            <footer class="p-8 border-t bg-slate-50 flex justify-end gap-3">
                <button onclick="toggleCompanionForm(false)" class="px-8 py-3 rounded-xl font-black text-[10px] uppercase text-slate-400 hover:text-slate-600">Descartar</button>
                <button onclick="saveCompanion()" class="px-10 py-3 bg-indigo-600 text-white rounded-xl font-black text-[10px] uppercase shadow-lg">Sincronizar Acompañante</button>
            </footer>
        </div>
    </div>